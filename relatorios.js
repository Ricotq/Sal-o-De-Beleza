        ...
        var database = firebase.database();
            ...
            databaseRef.once('value', function(snapshot){
                snapshot.forEach(function (childSnapshot){
                    ...
                    if(childData.agenda_horario===childData.horario_origem && idcliente===childData.user_id){
                        ...
                        if(dataInicio && dataFim){
                            if(data_Fim>=data_Inicio){
                                ...
                                //alert("Data final tem que ser maiór que a data inicial...");

                            }

                        }
                        if(!dataInicio && dataFim){
                            //alert("Data inicial não foi digitada...");
                        }
                    }
                });
...
function criarLinhaDeSeparacao(){
    ...
    function criarTabela(data,horario,especialidade,userNome,profNome,cor,countador,compareceu,pagou,valor,desconto,valorFinal,tipoDesconto,dataRec){
            ...
            if(pagou){
                ...
                document.getElementById('dataRecebimento'+countador).disabled= true;
            }else{
                document.getElementById('pagou'+countador).checked= false;
                document.getElementById('valorDesconto'+countador).disabled= false;
                document.getElementById('dataRecebimento'+countador).disabled= false;
            }
