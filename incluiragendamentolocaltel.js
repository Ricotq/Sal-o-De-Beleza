...
var nomeEscolhido=[];
var qtyDivs = 0;
var numTel = document.getElementById('telefone').value;
...
var clienteId = [];
var clienteNome = [];
function testeDeTabelas(numTel){
    ...
    populateRef.once('value', function(snapshot){
        ...
        if (flag>1 && flagUsuarioExiste===0){
            ...
            alert('Númerode telefone não existe...');
